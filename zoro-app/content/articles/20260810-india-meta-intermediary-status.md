...
The Indian government's position, as articulated across multiple policy documents and public statements, is straightforward: if you're selecting content — even through an algorithm — you're no longer an intermediary. You're a publisher.
...
- **Content moderation at scale**: A platform with 1 million active users posting daily would need a moderation team to review and remove illegal content within 72 hours. India's compliance costs for a mid-sized platform could range from ₹2-5 crore annually, according to estimates from legal firms specializing in digital regulation.
- **Liability insurance**: Platforms would need to insure against user-generated content liability, a product that doesn't really exist at scale in India.
...
The European Union's Digital Services Act takes a different approach. It distinguishes between "hosting" services and "recommendation systems," with heavier obligations for platforms that use algorithms to surface content. The DSA recognizes that recommendation is different from hosting.
...
As of now, the question remains open. No court has ruled on it. The government hasn't formally stated its position in a way that creates binding precedent. But the trajectory is clear.
...
The internet's operating system in India is still being written. And the question at stake is whether Indian startups can build the same kinds of intelligent platforms that exist elsewhere in the world, or whether the legal framework will force them to build something simpler, slower, and less useful.

## The Bottom Line

Section 79 made India's internet possible. The algorithm is what might change it.

The Indian government is asking whether a platform that recommends content is still an intermediary. The answer to that question will determine what kind of internet India gets: one where platforms serve you what you want, or one where platforms show you everything and hope you find it.
