...
export const NAG_LANDING_TOOLS: NagLandingTool[] = [
  {
    ...
    mcpName: 'nags.onboarding.email_check',
    rowTitle: 'nags.onboarding.email_check',
    section: 'auth',
  ...
  },
  {
    ...
    mcpName: 'nags.onboarding.request_link',
    rowTitle: 'nags.onboarding.request_link',
    section: 'auth',
  ...
  },
  {
    ...
    mcpName: 'nags.profile.reset_token',
    rowTitle: 'nags.profile.reset_token',
    section: 'auth',
  ...
  {
    id: 'webhooks_list',
    mcpName: 'nags.webhooks.list',
    rowTitle: 'nags.webhooks.list',
    section: 'webhooks',
  ...
  },
  {
    ...
    mcpName: 'nags.webhooks.register',
    rowTitle: 'nags.webhooks.register',
    section: 'webhooks',
  ...
  {
    id: 'webhooks_verify',
    mcpName: 'nags.webhooks.verify',
    rowTitle: 'nags.webhooks.verify',
    section: 'webhooks',
  ...
  {
    id: 'webhooks_ping',
    mcpName: 'nags.webhooks.ping',
    rowTitle: 'nags.webhooks.ping',
    section: 'webhooks',
  ...
  {
    id: 'webhooks_delete',
    mcpName: 'nags.webhooks.delete',
    rowTitle: 'nags.webhooks.delete',
    section: 'webhooks',
  ...
  {
    id: 'nag_profile',
    mcpName: 'nags.profile.set_timezone',
    rowTitle: 'nags.profile.set_timezone',
    section: 'profile',
  ...
  {
    id: 'user_data_get',
    mcpName: 'nags.profile.get_user_data',
    rowTitle: 'nags.profile.get_user_data',
    section: 'profile',
