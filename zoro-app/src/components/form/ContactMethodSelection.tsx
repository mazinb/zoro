...
import { EmailAuthInline } from './EmailAuthInline';
        ...
        <div className="space-y-4 mb-6">
          ...
          <Card darkMode={darkMode} className="p-6 shadow-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className={`font-semibold ${themeClasses.textClass} text-lg`}>Email Login <span className="text-red-500">*</span></h3>
            </div>
          ...
          <Card darkMode={darkMode} className="p-6 shadow-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className={`font-semibold ${themeClasses.textClass} text-lg`}>WhatsApp <span className={themeClasses.textSecondaryClass}>(Optional)</span></h3>
            </div>
