      ...
      contents: [
        {
          ...
          text: [
            ...
            '- **wealth.expenses.monthly** — monthly bucket totals.',
            '- **wealth.expenses.estimates** — saved estimates.',
            '- **wealth.fx.rates** / **wealth.fx.coverage** — FX and gaps.',
            '',
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              'Call wealth.expenses.monthly and summarize top categories + anomalies.',
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              'Call wealth.expenses.estimates, then summarize trend direction and biggest drivers.',
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              'Call wealth.fx.rates and summarize base currencies + date coverage.',
              'If there are missing conversions, also call wealth.fx.coverage.',
            ].join('\n'),
          },
        },
      ],
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              token ? `Use this token override: ${token}` : 'Use configured token header/env.',
              'Call wealth.fx.coverage and return missing month/currency pairs.',
