...
const countryPresets = <CountryPreset>[
  CountryPreset(
    ...
    buckets: {
      ...
      'transportation': ExpenseBucketPreset(
      ...
      'healthcare': ExpenseBucketPreset(
      ...
      'entertainment': ExpenseBucketPreset(
